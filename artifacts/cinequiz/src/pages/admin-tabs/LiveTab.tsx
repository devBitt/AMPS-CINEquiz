      ...
      <div className="glass-card p-8 rounded-2xl border border-border flex flex-col justify-center items-center text-center">
        ...
        {currentRoundIsActive ? (
          <div className="space-y-8 w-full">
            <div>
              <div className="text-6xl font-display text-primary tracking-widest mb-2">ROUND {activeRound?.roundNumber || competition.currentRound}</div>
              <div className="text-4xl drop-shadow-lg">{activeRound?.emojiClue}</div>
            </div>
